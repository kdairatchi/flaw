module Flaw
  abstract class Rule
    ...
    METADATA = {
      ...
      "FLAW100" => {cwe: "CWE-1164", owasp: nil},
      "FLAW101" => {cwe: "CWE-1164", owasp: nil},
      "FLAW102" => {cwe: "CWE-1188", owasp: "A05:2021"},
      "FLAW103" => {cwe: "CWE-1163", owasp: nil},
      "FLAW104" => {cwe: "CWE-390", owasp: nil},
      "FLAW105" => {cwe: "CWE-862", owasp: "A01:2021"},
      "FLAW106" => {cwe: "CWE-1078", owasp: nil},
      "FLAW107" => {cwe: "CWE-1188", owasp: nil},
      "FLAW108" => {cwe: "CWE-1164", owasp: nil},
      "FLAW109" => {cwe: "CWE-1164", owasp: nil},
      "FLAW110" => {cwe: "CWE-1098", owasp: nil},
      "FLAW111" => {cwe: "CWE-1078", owasp: nil},
      "FLAW112" => {cwe: "CWE-94", owasp: "A03:2021"},
      "FLAW113" => {cwe: "CWE-79", owasp: "A03:2021"},
      "FLAW114" => {cwe: "CWE-494", owasp: "A08:2021"},
      "FLAW115" => {cwe: "CWE-732", owasp: "A01:2021"},
      "FLAW116" => {cwe: "CWE-502", owasp: "A08:2021"},
      "FLAW117" => {cwe: "CWE-1022", owasp: "A05:2021"},
      "FLAW118" => {cwe: "CWE-1390", owasp: nil},
      ...
      "FLAW132" => {cwe: "CWE-917", owasp: "A03:2021"},
      "FLAW133" => {cwe: "CWE-943", owasp: "A03:2021"},
      "FLAW134" => {cwe: "CWE-489", owasp: "A05:2021"},
      "FLAW135" => {cwe: "CWE-532", owasp: "A09:2021"},
      "FLAW136" => {cwe: "CWE-918", owasp: "A10:2021"},
      "FLAW137" => {cwe: "CWE-798", owasp: "A07:2021"},
      "FLAW138" => {cwe: "CWE-506", owasp: "A03:2021"},
      "FLAW139" => {cwe: "CWE-494", owasp: "A08:2021"},
      "FLAW140" => {cwe: "CWE-506", owasp: "A03:2021"},
      "FLAW141" => {cwe: "CWE-506", owasp: nil},
      "FLAW142" => {cwe: "CWE-506", owasp: "A03:2021"},
      "FLAW143" => {cwe: "CWE-250", owasp: "A01:2021"},
      "FLAW144" => {cwe: "CWE-1395", owasp: "A06:2021"},
      "FLAW145" => {cwe: "CWE-78", owasp: "A03:2021"},
      "FLAW146" => {cwe: "CWE-250", owasp: "A01:2021"},
      "FLAW147" => {cwe: "CWE-284", owasp: "A01:2021"},
      "FLAW148" => {cwe: "CWE-540", owasp: "A05:2021"},
      "FLAW149" => {cwe: "CWE-1357", owasp: "A06:2021"},
      "FLAW150" => {cwe: "CWE-732", owasp: "A01:2021"},
      "FLAW151" => {cwe: "CWE-1039", owasp: "A03:2021"},
      "FLAW152" => {cwe: "CWE-1039", owasp: "A03:2021"},
      "FLAW153" => {cwe: "CWE-79", owasp: "A03:2021"},
      "FLAW154" => {cwe: "CWE-23", owasp: "A01:2021"},
      "FLAW155" => {cwe: "CWE-770", owasp: "A04:2021"},
      "FLAW156" => {cwe: "CWE-918", owasp: "A10:2021"},
      "FLAW157" => {cwe: "CWE-1357", owasp: "A06:2021"},
    }
